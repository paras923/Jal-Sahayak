...
const I18N = {
  ...
  gu: {
    ...
    stat_rainfall: 'તાજો વાર્ષિક વરસાદ', stat_rainfall_sub: '500mm સ.મ. સામે',
    ...
    chart_gauge_title: 'દુષ્કાળ જોખમ ગૉજ', chart_gauge_sub: 'સં.સૂ. (0–100)',
    ...
    trends_subtitle: 'ઐ.બ.વ. વિશ્લેષણ · વરસાદ-ભૂ.જ. સહ-સં. · પૂર્વ/પશ્ચ સંરક્ષ. સ.મ.',
    trends_analyse: 'જિલ્લો વિશ્લેષો:',
    tab_regional: 'ક્ષેત્રીય વરસાદ', tab_gwdepth: 'ભૂ.જ. ઊ. ટ્રેન્ડ',
    tab_recharge: 'સંરક્ષ. અસર', tab_correlation: 'વ.-ભૂ.જ. સ.સ.',
    // Advisory
    adv_title: 'AI-સંચાલિત જળ સલાહ',
    adv_subtitle: 'સિંચાઈ સૂચિ · જળ-સ્ત્રોત ભ. · 30/60/90-દ. દ.પૂ.અ. · પાક-વિ. માર્ગ.',
    adv_form_title: 'સલાહ ઉત્પ. કરો',
    adv_form_desc: 'વ્યક્તિગત જળ વ્ય. સ. મેળવવા ખ. વિ. દાખલ કરો.',
    adv_label_district: 'તમારો જિલ્લો', adv_label_crop: 'મુખ્ય પાક', adv_label_land: 'ભૂ. કદ (હૅક.)',
    adv_engine_note: '💡 નિ.ન.ઇ. દ્વારા ઉ. સ.: વ.ઘ., ભૂ.જ. ઊ., CGWB ત.વ., પ.જ.જ. — ઑ. ઑ.ઑ.',
    adv_btn_generate: '🤖 સલાહ ઉ. કરો',
    adv_quick_select: 'ઝડ. જ.પ.',
    adv_output_title: 'સ. પ.',
    adv_placeholder_title: 'તમારી સ. અહીં દ. થ.',
    adv_placeholder_desc: 'ત.જ., પ.પ. અ. ભૂ.ક. પ.ક., "સ.ઉ.ક." ક્લ. કરો.',
    // Resources
    res_title: 'ખેડૂત સ.',
    res_subtitle: 'પ.બ.ત. · સ.ય. · KVK · શ્.પ.',
    res_irr_eyebrow: 'સ. ત.', res_irr_title: 'પ. બ. સ. પ.',
    res_drip_title: 'ટ.સ. (ટ.સ.)',
    res_drip_desc: 'પ. સ. મ. ઝ.મ. પ., 35–50% ઓ. વ., મ., ક., શ. આ.',
    res_sprinkler_title: 'છ.સ. (છ.)',
    res_sprinkler_desc: 'સ. પ. વ. 20–30% પ.બ. ઘ., બ., જ. શ્.',
    res_mulch_title: 'આ. (Mulching)',
    res_mulch_desc: '30–40% બ.ઘ., ઘ.ઊ. ઘ.',
    res_laser_title: 'લ. ભૂ.',
    res_laser_desc: 'GPS/લ. ત. 20–30% સ.ક. સ.',
    res_drought_var_title: 'દ. સ. જ.',
    res_drought_var_desc: 'GG-20, TAG-24 (મ.); NH-615 (ઘ.); GHB-732 (બ.) — SAU જૂ. ભ.',
    res_pond_title: 'ખ. ત. (ખ. ત.)',
    res_pond_desc: 'ખ.ત.(20×20×3m) ચ.જ. PMKSY 50% સ.',
    res_schemes_eyebrow: 'સ. ય.', res_schemes_title: 'મ. જ. ક. ય.',
    res_pmksy_desc: "ભ.પ.સ.ય. — 55% સ. ટ./છ. સ., ખ.ત., વ.વ.",
    res_kvk_eyebrow: 'સ. અ. સ.', res_kvk_title: 'ક. વ. કે. (KVK) — સ.',
    // About
    about_title: 'વિ. અ. ડ.સ.',
    about_subtitle: 'પ., ડ.ઉ., ઉ., ડ.',
    about_purpose_desc: 'જ. સ. ત. ખ., સ.સ., ભ.જ.સ.મ. ને સ., ભ.ગ., ભ.ઘ. સ.ઘ. — R.B. + L.W.API + R.B.E.',
  },
